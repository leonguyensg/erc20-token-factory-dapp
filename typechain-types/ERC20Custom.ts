...
export interface ERC20CustomInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC20Custom extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Custom;
  ...
  isBurnable: TypedContractMethod<[], [boolean], "view">;
